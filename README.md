...
[![My Skills](https://skillicons.dev/icons?i=python,tensorflow,pytorch,scala,tailwind,postgresql,ts,docker,react,kubernetes,js,next,nodejs,mongodb,git,github,vscode,jest,postman,django&perline=10)](#)
