...
[![My Skills](https://skillicons.dev/icons?i=python,tensorflow,pytorch,tailwind,postgresql,ts,docker,react,kubernetes,js,next,nodejs,mongodb,git,github,vscode,jest,postman,scala,django&perline=10)](#)
