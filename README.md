...
[![My Skills](https://skillicons.dev/icons?i=python,tensorflow,pytorch,ts,postgresql,css,tailwind,js,react,next,nodejs,mongodb,git,github,vscode,jest,styledcomponents,postman,scala,django&perline=13)](#)
