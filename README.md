...
[![My Skills](https://skillicons.dev/icons?i=python,tensorflow,pytorch,postgresql,css,tailwind,js,react,ts,next,nodejs,mongodb,git,github,vscode,jest,styledcomponents,postman,scala,cplusplus,django&perline=13)](#)
