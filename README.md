...
[![My Skills](https://skillicons.dev/icons?i=python,tensorflow,pytorch,tailwind,postgresql,ts,docker,kubernetes,js,react,next,nodejs,mongodb,git,github,vscode,jest,postman,scala,django&perline=10)](#)
